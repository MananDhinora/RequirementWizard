...
export default function DocumentOutput() {
  ...
  const { document, isGenerating, error, resetError } = useDocumentGenerator();
  ...
  const handleDownload = () => {
    ...
    const extension = document.format === 'html' 
      ? 'html' 
      ...
      <div className="p-6 h-full flex flex-col">
        ...
        {!isGenerating && !document?.content && !error && (
          <div className="flex-grow flex flex-col items-center justify-center text-gray-500">
            ...
            <p className="text-xs text-center max-w-sm">Fill out the project description and click "Generate PRD" to create your document</p>
          </div>
        )}
