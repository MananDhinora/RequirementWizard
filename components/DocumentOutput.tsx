      ...
      <CardContent className="flex-grow relative overflow-auto pb-2">
        ...
        {isGenerating && (
          <div className="flex-grow flex flex-col items-center justify-center text-gray-500 py-8">
            ...
            <p className="text-center font-medium">Generating your document...</p>
            <p className="text-center text-sm mt-2">This may take a moment, please wait.</p>
          </div>
        )}
          ...
          <div>
            <Button 
              onClick={() => {
                ...
                const tabEvent = new CustomEvent('switch-tab', { detail: 'list' });
